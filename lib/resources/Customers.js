...
module.exports = StripeResource.extend({
  ...
  deleteCard: stripeMethod({
   ...
   /**
   * Customer: Bank_Accounts methods
   */

  createBankAccount: stripeMethod({
    method: 'POST',
    path: '/{customerId}/bank_accounts',
    urlParams: ['customerId']
  }),

  listBankAccounts: stripeMethod({
    method: 'GET',
    path: '/{customerId}/bank_accounts',
    urlParams: ['customerId']
  }),

  retrieveBankAccount: stripeMethod({
    method: 'GET',
    path: '/{customerId}/bank_accounts/{bankAccountId}',
    urlParams: ['customerId', 'bankAccountId']
  }),

  updateBankAccount: stripeMethod({
    method: 'POST',
    path: '/{customerId}/bank_accounts/{bankAccountId}',
    urlParams: ['customerId', 'bankAccountId']
  }),

  deleteBankAccount: stripeMethod({
    method: 'DELETE',
    path: '/{customerId}/bank_accounts/{bankAccountId}',
    urlParams: ['customerId', 'bankAccountId']
  }),
